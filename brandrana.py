...
logo = """\033[1;95m  ____  _   _    _    _   _ _____ ___  
...
\033[1;90m════════════════════════════════════════════════
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mFACEBOOK : Rana Brand  
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mFB GROUP : Rana Brand
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mGITHUB   : R-4-RANA
...
class Main:
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[RANA] : %s/%s -> \033[0;97m [OK:%s ] \033[0;97m[CP:%s ]"%(W,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r  \033[0;91m   [RANA-CP] %s | %s\033[0;97m         "%(uid, pw))
